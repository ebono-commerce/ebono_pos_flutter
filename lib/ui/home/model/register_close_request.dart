...
RegisterCloseRequest registerCloseRequestFromJson(str) => RegisterCloseRequest.fromJson(json.decode(str));

String registerCloseRequestToJson(RegisterCloseRequest data) => json.encode(data.toJson());
...
class RegisterCloseRequest {
  ...
  factory RegisterCloseRequest.fromJson(Map<String, dynamic> json) => RegisterCloseRequest(
    outletId: json["outlet_id"],
    registerId: json["register_id"],
    registerTransactionId: json["register_transaction_id"],
    terminalId: json["terminal_id"],
    userId: json["user_id"],
    transactionSummary: json["transaction_summary"] == null ? [] : List<TransactionSummary>.from(json["transaction_summary"]!.map((x) => TransactionSummary.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "user_id": userId,
    "transaction_summary": transactionSummary == null ? [] : List<dynamic>.from(transactionSummary!.map((x) => x.toJson())),
  };
}
...
class TransactionSummary {
  ...
  factory TransactionSummary.fromJson(Map<String, dynamic> json) => TransactionSummary(
    ...
    totalTransactionAmount: json["total_transaction_amount"] == null ? null : TotalTransactionAmount.fromJson(json["total_transaction_amount"]),
  );
...
class TotalTransactionAmount {
  ...
  factory TotalTransactionAmount.fromJson(Map<String, dynamic> json) => TotalTransactionAmount(
