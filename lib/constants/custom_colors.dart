...
class CustomColors {
  ...
  static final accentColor = Colors.amberAccent[100];
  ...
  static final dialogGreyBackground = const Color(0xFFF8F8F8);
  static final disabledTextFormFieldBackground = const Color(0xFFF1F1F1);
}
